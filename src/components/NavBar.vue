    ...
    nav{
        ...
        .wrapper{
            ...
            .menu {
                ...
                &-login{
                    @apply rounded-md bg-green-700 px-4 py-2 hover:bg-yellow-500 hover:text-slate-900;
                }
                &-logout{
                    @apply mx-2 rounded-md bg-red-900 px-4 py-2 hover:bg-yellow-500 hover:text-slate-900;
                }
            }
        }
    }
